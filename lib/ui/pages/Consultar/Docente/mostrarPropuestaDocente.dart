...
class MostrarPropuestaDocente extends StatefulWidget {
  final Propuesta propuesta;

  const MostrarPropuestaDocente({
    super.key,
    required this.propuesta,
  });

  @override
  State<MostrarPropuestaDocente> createState() =>
      _MostrarPropuestaDocenteState();
}

class _MostrarPropuestaDocenteState extends State<MostrarPropuestaDocente> {
